...
export class PacienteComponent {
  ...
  apresentarStatus(): void {
    this.calcularImc(); //Realizar o cálculo caso ainda nao tenha sido realizado
    ...
    if (this.imcResultado < 18.5) {
      this.imcStatusResultado = "abaixo de peso";
    } else if (this.imcResultado < 25) {
      this.imcStatusResultado = "Peo normal";
      ...
      this.imcStatusResultado = "Obsidade grau II";
    } else {
      this.imcStatusResultado = "Obesidade graw III";
    }
  }
  ...
  calcularImc(): void {
    ...
    if (this.altura === null) {
      alert("Altura deve ser prennchida");
      return;
    }
